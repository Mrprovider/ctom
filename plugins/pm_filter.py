...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text="<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ <a href=https://t.me/movies_hub_official1>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ​👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"t.me/movies_hub_official3")]]))
    ...
    if query.data.startswith("file"):
                ...
                mh = await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[ 
                          ...
                          InlineKeyboardButton("🔋 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ​ 🔋", url='t.me/TG_UPDATES1')
                        ]]
                    )
                )
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton("❤️‍🔥 ᴍᴏᴠɪᴇs​ ❤️‍🔥", url='https://t.me/TG_LINKS_CHANNEL')
                 ]
                ]
            )
        )
        ...
        buttons = [[
            InlineKeyboardButton('⇍ ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('✧ ᴄᴏɴᴛᴀᴄᴛ​', url='t.me/KUSHALHK')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        buttons = [[
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ sᴜᴘᴘᴏʀᴛ', url='https://t.me/TG_SUPPORT_GROUP')
        ],[
            InlineKeyboardButton('⇍ ʙᴀᴄᴋ', callback_data='start'),
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.answer("⚠ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ⚠\n\nIᴛꜱ ᴏɴʟʏ ғᴏʀ ᴍʏ ADMINS\n\n©TG UPDATES BOT", show_alert=True)
        ...
        try:
            if message.chat.id == SUPPORT_CHAT_ID:
                await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('📌 Rᴇǫᴜᴇꜱᴛ Hᴇʀᴇ', url ='https://t.me/movies_hub_official2')
                        ]]
                    )
                )
            else:
